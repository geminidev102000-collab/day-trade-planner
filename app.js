document.addEventListener('DOMContentLoaded', () => {
            ...
            if (progress === 100) {
                ...
                setTimeout(() => {
                    ...
                    if (mood === 'fomo' || mood === 'anxious') {
                        ...
                        iconSpan1.className = 'alert-icon';
                        iconSpan1.textContent = '⚠️';
                        const strongText1 = document.createElement('strong');
                        strongText1.textContent = 'Caution:';
                        alertDiv.appendChild(iconSpan1);
                        alertDiv.appendChild(strongText1);
    ...
    function loadJournalEntries() {
        ...
        if (trades.length === 0) {
            entriesContainer.textContent = ''; // Clear contents
